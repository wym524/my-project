...
if __name__ == "__main__":
    ...
    stdin, stdout, stderr = client.exec_command('curl -sI http://127.0.0.1:3000/login.html | head -10')
    print("=== HTTP Headers for login.html ===")
    print(stdout.read().decode())
    
    # Check if express static middleware is configured
    stdin, stdout, stderr = client.exec_command('grep -n "express.static\\|static(" /opt/my-app/server.js | head -10')
